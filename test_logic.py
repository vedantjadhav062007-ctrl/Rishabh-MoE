...
print(f"[System] Loading {latest_ckpt} to CPU to test logic safely...", flush=True)
...
prompt = "<problem>A train travels at 60 km/h for 2.5 hours. How far did the train travel in total?</problem><thinking>"
input_ids = encode(prompt)

print(f"\nPROMPT: {prompt}")
print(f"GENERATED THOUGHT PROCESS:")
