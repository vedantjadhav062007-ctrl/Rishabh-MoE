...
print("[System] Loading sft_8bit_test.pt to CPU...", flush=True)
config = RishabhConfig()
model = Rishabh(config).to(torch.bfloat16)
checkpoint = torch.load('/opt/rishabh_experimental/sft_8bit_test.pt', map_location='cpu', weights_only=True)
